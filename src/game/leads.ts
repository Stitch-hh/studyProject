...
const DUCK_POOL: Omit<Lead, 'id' | 'kind'>[] = [
  {
    ...
    blurb: 'Жилец с пятого этажа третий раз звонит на пульт: по ночам в подъезде кто-то хохочет и гасит лампы. Управляющая компания разводит руками.',
    signal: 'Третий звонок за месяц. Свидетелей нет, мха нет, фон чистый.',
  },
  {
    title: 'Круги во дворе',
    blurb: 'На районном форуме разошлось фото: ровные круги на снегу у детской площадки. В комментариях уже собирают ночное дежурство.',
    signal: 'Геометрия ровная — но и следы от санок ровные. Похоже на вброс.',
  },
  {
    title: 'Салон «потомственной ведуньи»',
    blurb: '«Потомственная ведунья» с Ярмарочной сама пришла на пульт: просит Стражу официально заверить, что её салон чист. Настойчиво просит.',
    signal: 'Саморегистрации нет, но и нарушений нет: обычная гадалка-человек.',
  },
  {
    title: 'Призрак в маршрутке',
    blurb: 'Водитель 34-го маршрута отказывается от ночной смены: «на заднем сиденье кто-то дышит». Сменщик подтверждает, но путается в деталях.',
    signal: 'Скорее переутомление. Фон в салоне — как у любого куска железа.',
  },
  {
    title: 'Вой у гаражей',
    blurb: 'Собачники слышат вой на пустыре за гаражами — «точно оборотень вышел». Участковый просил кого-нибудь прислать, чтобы успокоить район.',
    signal: 'Вой есть. Но оборотни к луне не привязаны, а фон — собачий. Псы и есть.',
  },
  {
    title: 'Порча по переписке',
    blurb: 'Женщина с Фабричной уверена: бывшая мужа навела порчу через голосовые сообщения. Приложила распечатку на одиннадцать листов.',
